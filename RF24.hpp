...
class RF24 {
    private:
        ...
        uint _clk_pin, _mosi_pin, _miso_pin;
        uint _ce_pin, _cs_pin, _spi_speed;
    ...
    public:
         ...
         */
        RF24(spi_inst_t *spi_port, uint mosi_pin, uint miso_pin, uint clk_pin, uint ce_pin, uint cs_pin, uint spi_speed = RF24_SPI_SPEED);
